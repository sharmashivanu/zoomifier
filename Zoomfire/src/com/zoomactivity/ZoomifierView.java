...
public class ZoomifierView extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			webViewZoomOutAnimation = AnimationUtils.loadAnimation(
					ZoomifierView.this, R.anim.zoom_out_animation);
			webViewZoomInAnimation = AnimationUtils.loadAnimation(
					ZoomifierView.this, R.anim.zoom_in_popupview);
		...
		sharebuton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (layout.getVisibility() == View.VISIBLE) {
					...
					Display display = ((WindowManager) getSystemService(ZoomifierView.this.WINDOW_SERVICE))
							.getDefaultDisplay();
					...
					if (orientation == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE
						...
						int pixel = ZoomifierView.this.getWindowManager()
	...
	public void init() {
		webView = (TouchImageView) findViewById(R.id.webview);
	...
	public void settingDialog() {
		settingDialog = new Dialog(ZoomifierView.this,
	...
	public void stardialog() {
		...
		RelativeLayout layout = (RelativeLayout) findViewById(R.id.setting_dialog_layout);
		layout.setVisibility(View.GONE);
		final Dialog userInfoDialog = new Dialog(ZoomifierView.this);
		...
		AgendaTimeAdapNew adapter = new AgendaTimeAdapNew(ZoomifierView.this,
				112, reviewList);
		...
		writereviewButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				final Dialog reveiewDialgo = new Dialog(ZoomifierView.this);
					...
					public void onClick(View v) {
						...
						if (submitButton.getTag().equals(R.drawable.red_submit)) {
							...
							AgendaTimeAdapNew adapter = new AgendaTimeAdapNew(
									ZoomifierView.this, 112, reviewList);
							listview.setAdapter(adapter);
		...
		protected void onPostExecute(Void result) {
			...
			if (shareResponse.equals("success")) {
				...
				if (documetnlikeactivity) {
					...
					Intent intent = new Intent(ZoomifierView.this,
